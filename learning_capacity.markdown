...
<div class="row mt-4 text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="emp-card">
      <h4 class="alt-h4">EMP-LAC 2025 – Buenos Aires, Argentina</h4>
      <img src="{{ site.baseurl }}/assets/img/EMP/emp-lac-2024.png" class="img-fluid img-border mb-2" alt="EMP-LAC 2025">
      <p>Held from 3 to 14 February at Universidad Nacional de La Matanza (UNLaM). Co-hosted by CCG, UNLaM, Universidade Federal de Juiz de Fora, and the British Embassy in Argentina.</p>
      <details>
  ...
  <div class="col-md-4 mb-4">
    <div class="emp-card">
      <h4 class="alt-h4">EMP-G 2024 – Trieste, Italy</h4>
      <img src="{{ site.baseurl }}/assets/img/EMP/emp-g-2024.png" class="img-fluid img-border mb-2" alt="EMP-G 2024">
      <p>Held from 12–23 August at ICTP. Seven national teams developed country-specific models.</p>
      <details>
        <summary class="btn btn-sm btn-outline toggle-arrow">Show Outputs</summary>
        <ul class="mt-2 text-left">
  ...
  <div class="col-md-4 mb-4">
    <div class="emp-card">
      <h4 class="alt-h4">EMP-A 2024 – Accra, Ghana</h4>
      <img src="{{ site.baseurl }}/assets/img/EMP/emp-a-2024.png" class="img-fluid img-border mb-2" alt="EMP-A 2024">
      <p>Held from 20–31 May at Ghana Institute of Management and Public Administration. Ten teams worked on national energy models.</p>
      <details>
        <summary class="btn btn-sm btn-outline toggle-arrow">Show Outputs</summary>
        <ul class="mt-2 text-left">
